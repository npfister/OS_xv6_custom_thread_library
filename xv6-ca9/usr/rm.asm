...
printint(int fd, int xx, int base, int sgn)
{
    ...
    do{
     ...
     96c:	e3013158 	movw	r3, #4440	; 0x1158
...
printf(int fd, char *fmt, ...)
{
    ...
    for(i = 0; fmt[i]; i++){
     ...
     b7c:	1a00000c 	bne	bb4 <printf+0x16c>
                    s = "(null)";
     b80:	e3013150 	movw	r3, #4432	; 0x1150
...
free(void *ap)
{
    ...
    for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     c9c:	e3013174 	movw	r3, #4468	; 0x1174
...
free(void *ap)
{
    ...
    freep = p;
     de0:	e3013174 	movw	r3, #4468	; 0x1174
...
morecore(uint nu)
{
    ...
    return freep;
     e70:	e3013174 	movw	r3, #4468	; 0x1174
...
malloc(uint nbytes)
{
    ...
    if((prevp = freep) == 0){
     eac:	e3013174 	movw	r3, #4468	; 0x1174
    ...
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
     ...
     f8c:	e5832004 	str	r2, [r3, #4]
            ...
            freep = prevp;
     f90:	e3013174 	movw	r3, #4468	; 0x1174
     ...
     fa8:	ea000013 	b	ffc <malloc+0x174>
        ...
        if(p == freep)
     fac:	e3013174 	movw	r3, #4468	; 0x1174
