...
main(int argc, char *argv[])
{
    ...
    for(i = 1; i < argc; i++){
      ...
      80:	e3011158 	movw	r1, #4440	; 0x1158
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    do{
     ...
     990:	e301317c 	movw	r3, #4476	; 0x117c
...
printf(int fd, char *fmt, ...)
{
    ...
    for(i = 0; fmt[i]; i++){
     ...
     ba0:	1a00000c 	bne	bd8 <printf+0x16c>
                    s = "(null)";
     ba4:	e3013174 	movw	r3, #4468	; 0x1174
...
free(void *ap)
{
    ...
    for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     cc0:	e3013198 	movw	r3, #4504	; 0x1198
...
free(void *ap)
{
    ...
    freep = p;
     e04:	e3013198 	movw	r3, #4504	; 0x1198
...
morecore(uint nu)
{
    ...
    return freep;
     e94:	e3013198 	movw	r3, #4504	; 0x1198
...
malloc(uint nbytes)
{
    ...
    if((prevp = freep) == 0){
     ed0:	e3013198 	movw	r3, #4504	; 0x1198
    ...
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
     ...
     fb0:	e5832004 	str	r2, [r3, #4]
            ...
            freep = prevp;
     fb4:	e3013198 	movw	r3, #4504	; 0x1198
     ...
     fcc:	ea000013 	b	1020 <malloc+0x174>
        ...
        if(p == freep)
     fd0:	e3013198 	movw	r3, #4504	; 0x1198
